...
--IF YOU ARE NOT USING CERTAIN NAME SLOTS, JUST LEAVE THEM BLANK 
	...
	CoderName1 = 'Woyer 106             Lallz G'
	CoderName2 = ''
	CoderName3 = 'Kit Dyer            Ja vtuber'

	ArtistName1 = ''
	ArtistName2 = 'Atreyu apcy'
	ArtistName3 = ' '

	MusicianName1 = ''
	MusicianName2 = 'SDLM Miseria'
	MusicianName3 = ''

	CharterName1 = ''
	CharterName2 = 'woyer 106'
	CharterName3 = '' 
...
Font = 'PermanentMarker-Regular.ttf' --Change the Font here if needed
...
function onCreate()
	...
	makeGraphic('Main', 570, 1300, 'FC2828')
	...
	makeGraphic('BorderLeft', 4, 1300, 'FF5555')
	...
	makeGraphic('BorderRight', 4, 1300, 'FF5555')
