...
class MainMenuState extends MusicBeatState
{
	...
	override function update(elapsed:Float)
	{
		...
		if (FlxG.mouse.overlaps(christChan) && FlxG.mouse.justPressed) {
			MusicBeatState.switchState(new StoryMenuState());
		}
		if (FlxG.mouse.overlaps(dalas) && FlxG.mouse.justPressed) {
			MusicBeatState.switchState(new StoryMenuState());
		}
		if (FlxG.mouse.overlaps(doom) && FlxG.mouse.justPressed) {
			MusicBeatState.switchState(new StoryMenuState());
		}
		if (FlxG.mouse.overlaps(niko) && FlxG.mouse.justPressed) {
			MusicBeatState.switchState(new StoryMenuState());
		}
		if (FlxG.mouse.overlaps(songs) && FlxG.mouse.justPressed) {
		...
		if (FlxG.mouse.overlaps(awards) && FlxG.mouse.justPressed) {
